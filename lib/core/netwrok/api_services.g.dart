...
class _ApiServices implements ApiServices {
  ...
  Future<List<ResturantModel>> getAllResturants() async {
    ...
    final _options = _setStreamType<List<ResturantModel>>(
    ...
    late List<ResturantModel> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) => ResturantModel.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
  ...
  @override
  Future<List<ItemModel>> searchOnItem(String? itemName) async {
    final _extra = <String, dynamic>{};
